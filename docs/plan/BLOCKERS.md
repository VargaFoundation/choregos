...
| S13 | S13-04, S13-05 | Aucun compte Jira Cloud, GitLab ou Azure n'est joignable depuis cet environnement : les adaptateurs ne peuvent pas être joués contre le vrai service. | Les trackers Jira et GitLab sont **écrits** et testés contre le protocole documenté (transport HTTP simulé, 29 tests) : forme des requêtes, transitions Jira, labels scopés GitLab, webhooks normalisés. Ce qu'aucun test ici ne prouve : qu'une instance réelle accepte ces appels — à valider au premier projet Jira ou GitLab. L'`Executor` ACA (S13-05) reste non écrit ; l'interface a trois implémentations réelles (Tekton, Job K8s, Docker). | 2026-09-19 |
